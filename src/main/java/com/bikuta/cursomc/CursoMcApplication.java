...
import com.bikuta.cursomc.domain.Cidade;
...
import com.bikuta.cursomc.domain.enums.EstadoPagamento;
import com.bikuta.cursomc.domain.enums.TipoCliente;
import com.bikuta.cursomc.repositories.CategoriaRepository;
import com.bikuta.cursomc.repositories.CidadeRepository;
...
public class CursoMcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("912341234", "56785678"));
	
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto303", "Jardim", "08111011", cli1, c1);
		Endereco e2 = new Endereco(null, "Av. Matos", "105", "Sala 800", "Centro", "08222022", cli1, c2);
